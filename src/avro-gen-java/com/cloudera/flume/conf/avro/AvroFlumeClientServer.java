...
public interface AvroFlumeClientServer {
  public static final org.apache.avro.Protocol PROTOCOL = org.apache.avro.Protocol.parse("{\"protocol\":\"AvroFlumeClientServer\",\"namespace\":\"com.cloudera.flume.conf.avro\",\"types\":[{\"type\":\"record\",\"name\":\"FlumeReportAvro\",\"namespace\":\"com.cloudera.flume.reporter.server.avro\",\"fields\":[{\"name\":\"stringMetrics\",\"type\":{\"type\":\"map\",\"values\":\"string\"}},{\"name\":\"longMetrics\",\"type\":{\"type\":\"map\",\"values\":\"long\"}},{\"name\":\"doubleMetrics\",\"type\":{\"type\":\"map\",\"values\":\"double\"}}]},{\"type\":\"enum\",\"name\":\"FlumeNodeState\",\"symbols\":[\"HELLO\",\"IDLE\",\"CONFIGURING\",\"ACTIVE\",\"ERROR\",\"LOST\",\"DECOMMISSIONED\"]},{\"type\":\"record\",\"name\":\"AvroFlumeConfigData\",\"fields\":[{\"name\":\"timestamp\",\"type\":\"long\"},{\"name\":\"sourceConfig\",\"type\":\"string\"},{\"name\":\"sinkConfig\",\"type\":\"string\"},{\"name\":\"sourceVersion\",\"type\":\"long\"},{\"name\":\"sinkVersion\",\"type\":\"long\"},{\"name\":\"flowID\",\"type\":\"string\"}]}],\"messages\":{\"heartbeat\":{\"request\":[{\"name\":\"logicalNode\",\"type\":\"string\"},{\"name\":\"physicalNode\",\"type\":\"string\"},{\"name\":\"host\",\"type\":\"string\"},{\"name\":\"s\",\"type\":\"FlumeNodeState\"},{\"name\":\"timestamp\",\"type\":\"long\"}],\"response\":\"boolean\"},\"getConfig\":{\"request\":[{\"name\":\"physNode\",\"type\":\"string\"}],\"response\":[\"AvroFlumeConfigData\",\"null\"]},\"getLogicalNodes\":{\"request\":[{\"name\":\"physNode\",\"type\":\"string\"}],\"response\":{\"type\":\"array\",\"items\":\"string\"}},\"getChokeMap\":{\"request\":[{\"name\":\"physNode\",\"type\":\"string\"}],\"response\":{\"type\":\"map\",\"values\":\"int\"}},\"acknowledge\":{\"request\":[{\"name\":\"ackid\",\"type\":\"string\"}],\"response\":\"null\"},\"checkAck\":{\"request\":[{\"name\":\"ackid\",\"type\":\"string\"}],\"response\":\"boolean\"},\"putReports\":{\"request\":[{\"name\":\"reports\",\"type\":{\"type\":\"map\",\"values\":\"com.cloudera.flume.reporter.server.avro.FlumeReportAvro\"}}],\"response\":\"null\"}}}");
  ...
  java.lang.Void putReports(java.util.Map<java.lang.CharSequence,com.cloudera.flume.reporter.server.avro.FlumeReportAvro> reports) throws org.apache.avro.ipc.AvroRemoteException;
}
