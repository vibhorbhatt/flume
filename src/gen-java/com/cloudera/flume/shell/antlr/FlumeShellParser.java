...
public class FlumeShellParser extends Parser {
    ...
    // $ANTLR start "lines"
    // /home/vibhor/newflume/flume/src/antlr/FlumeShell.g:86:1: lines : command ( ';' command )* EOF -> ( command )+ ;
    public final FlumeShellParser.lines_return lines() throws RecognitionException {
        ...
        try {
            // /home/vibhor/newflume/flume/src/antlr/FlumeShell.g:86:7: ( command ( ';' command )* EOF -> ( command )+ )
            // /home/vibhor/newflume/flume/src/antlr/FlumeShell.g:86:9: command ( ';' command )* EOF
            {
            ...
            // /home/vibhor/newflume/flume/src/antlr/FlumeShell.g:86:17: ( ';' command )*
            loop1:
            do {
                int alt1=2;
                ...
                switch (alt1) {
            	case 1 :
            	    // /home/vibhor/newflume/flume/src/antlr/FlumeShell.g:86:18: ';' command
            	    {
    ...
    // $ANTLR start "line"
    // /home/vibhor/newflume/flume/src/antlr/FlumeShell.g:88:1: line : command EOF -> command ;
    public final FlumeShellParser.line_return line() throws RecognitionException {
        ...
        RewriteRuleSubtreeStream stream_command=new RewriteRuleSubtreeStream(adaptor,"rule command");
        try {
            // /home/vibhor/newflume/flume/src/antlr/FlumeShell.g:88:6: ( command EOF -> command )
            // /home/vibhor/newflume/flume/src/antlr/FlumeShell.g:88:8: command EOF
            {
    ...
    // $ANTLR start "command"
    // /home/vibhor/newflume/flume/src/antlr/FlumeShell.g:90:1: command : ( literal )+ -> ^( CMD ( literal )+ ) ;
    public final FlumeShellParser.command_return command() throws RecognitionException {
        ...
        try {
            // /home/vibhor/newflume/flume/src/antlr/FlumeShell.g:90:9: ( ( literal )+ -> ^( CMD ( literal )+ ) )
            // /home/vibhor/newflume/flume/src/antlr/FlumeShell.g:90:11: ( literal )+
            {
            // /home/vibhor/newflume/flume/src/antlr/FlumeShell.g:90:11: ( literal )+
            int cnt2=0;
            loop2:
            ...
            // 90:20: -> ^( CMD ( literal )+ )
            {
                // /home/vibhor/newflume/flume/src/antlr/FlumeShell.g:90:23: ^( CMD ( literal )+ )
                {
    ...
    // $ANTLR start "literal"
    // /home/vibhor/newflume/flume/src/antlr/FlumeShell.g:93:1: literal : ( DQuoteLiteral -> ^( DQUOTE DQuoteLiteral ) | SQuoteLiteral -> ^( SQUOTE SQuoteLiteral ) | Argument -> ^( STRING Argument ) );
    public final FlumeShellParser.literal_return literal() throws RecognitionException {
        ...
        try {
            // /home/vibhor/newflume/flume/src/antlr/FlumeShell.g:94:5: ( DQuoteLiteral -> ^( DQUOTE DQuoteLiteral ) | SQuoteLiteral -> ^( SQUOTE SQuoteLiteral ) | Argument -> ^( STRING Argument ) )
            int alt3=3;
            switch ( input.LA(1) ) {
            case DQuoteLiteral:
                {
            ...
            switch (alt3) {
                case 1 :
                    // /home/vibhor/newflume/flume/src/antlr/FlumeShell.g:94:9: DQuoteLiteral
                    {
                    ...
                    {
                        // /home/vibhor/newflume/flume/src/antlr/FlumeShell.g:94:26: ^( DQUOTE DQuoteLiteral )
                        {
                        Object root_1 = (Object)adaptor.nil();
                    ...
                    break;
                case 2 :
                    // /home/vibhor/newflume/flume/src/antlr/FlumeShell.g:95:9: SQuoteLiteral
                    {
                    ...
                    {
                        // /home/vibhor/newflume/flume/src/antlr/FlumeShell.g:95:26: ^( SQUOTE SQuoteLiteral )
                        {
                        Object root_1 = (Object)adaptor.nil();
                    ...
                    break;
                case 3 :
                    // /home/vibhor/newflume/flume/src/antlr/FlumeShell.g:96:9: Argument
                    {
                    ...
                    {
                        // /home/vibhor/newflume/flume/src/antlr/FlumeShell.g:96:24: ^( STRING Argument )
                        {
                        Object root_1 = (Object)adaptor.nil();
