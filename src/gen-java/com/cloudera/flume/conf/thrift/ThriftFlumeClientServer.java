...
public class ThriftFlumeClientServer {
  ...
  public interface Iface {
    ...
    public void putReports(Map<String,com.cloudera.flume.reporter.server.thrift.FlumeReportThrift> reports) throws TException;
  ...
  public static class Client implements Iface {
    ...
    public void send_putReports(Map<String,com.cloudera.flume.reporter.server.thrift.FlumeReportThrift> reports) throws TException
    {
...
;
  ...
  public static class putReports_args implements TBase<putReports_args._Fields>, java.io.Serializable, Cloneable   {
    ...
    public Map<String,com.cloudera.flume.reporter.server.thrift.FlumeReportThrift> reports;
    ...
    public static final Map<_Fields, FieldMetaData> metaDataMap = Collections.unmodifiableMap(new EnumMap<_Fields, FieldMetaData>(_Fields.class) {{
      put(_Fields.REPORTS, new FieldMetaData("reports", TFieldRequirementType.DEFAULT, 
          new MapMetaData(TType.MAP, 
              new FieldValueMetaData(TType.STRING), 
              new StructMetaData(TType.STRUCT, com.cloudera.flume.reporter.server.thrift.FlumeReportThrift.class))));
    }});
    ...
    public putReports_args(
      Map<String,com.cloudera.flume.reporter.server.thrift.FlumeReportThrift> reports)
    {
      this();
    ...
    public putReports_args(putReports_args other) {
      if (other.isSetReports()) {
        Map<String,com.cloudera.flume.reporter.server.thrift.FlumeReportThrift> __this__reports = new HashMap<String,com.cloudera.flume.reporter.server.thrift.FlumeReportThrift>();
        for (Map.Entry<String, com.cloudera.flume.reporter.server.thrift.FlumeReportThrift> other_element : other.reports.entrySet()) {

          String other_element_key = other_element.getKey();
          com.cloudera.flume.reporter.server.thrift.FlumeReportThrift other_element_value = other_element.getValue();

          String __this__reports_copy_key = other_element_key;

          com.cloudera.flume.reporter.server.thrift.FlumeReportThrift __this__reports_copy_value = new com.cloudera.flume.reporter.server.thrift.FlumeReportThrift(other_element_value);
    ...
    public void putToReports(String key, com.cloudera.flume.reporter.server.thrift.FlumeReportThrift val) {
      if (this.reports == null) {
        this.reports = new HashMap<String,com.cloudera.flume.reporter.server.thrift.FlumeReportThrift>();
      }
      this.reports.put(key, val);
    }

    public Map<String,com.cloudera.flume.reporter.server.thrift.FlumeReportThrift> getReports() {
      return this.reports;
    }

    public putReports_args setReports(Map<String,com.cloudera.flume.reporter.server.thrift.FlumeReportThrift> reports) {
      this.reports = reports;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case REPORTS:
        if (value == null) {
          ...
          setReports((Map<String,com.cloudera.flume.reporter.server.thrift.FlumeReportThrift>)value);
        }
        break;
              ...
              if (field.type == TType.MAP) {
                {
                  ...
                  this.reports = new HashMap<String,com.cloudera.flume.reporter.server.thrift.FlumeReportThrift>(2*_map9.size);
                  for (int _i10 = 0; _i10 < _map9.size; ++_i10)
                  {
                    String _key11;
                    com.cloudera.flume.reporter.server.thrift.FlumeReportThrift _val12;
                    _key11 = iprot.readString();
                    _val12 = new com.cloudera.flume.reporter.server.thrift.FlumeReportThrift();
                    _val12.read(iprot);
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.reports != null) {
        oprot.writeFieldBegin(REPORTS_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, com.cloudera.flume.reporter.server.thrift.FlumeReportThrift> _iter13 : this.reports.entrySet())
          {
